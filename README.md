# nvim-treesitter-queries-markdown

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-markdown/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-markdown/actions/workflows/validate.yml)

Neovim tree-sitter queries for **markdown**, part of the
...
- [ ] Changes are scoped to `markdown` — do not include files for other languages
